...
from ip_adapter.attention_processor import IfAttnProcessor2_1
...
def main():
    ...
    for name in unet.attn_processors.keys():
        ...
        if cross_attention_dim is None:
            ...
            weights = {
                "to_k_ifx.weight": unet_sd[layer_name + ".to_k.weight"],
                "to_v_ifx.weight": unet_sd[layer_name + ".to_v.weight"],
                "to_k_ify.weight": unet_sd[layer_name + ".to_k.weight"],
                "to_v_ify.weight": unet_sd[layer_name + ".to_v.weight"],
            }
            attn_procs[name] = IfAttnProcessor2_1(hidden_size=hidden_size, cross_attention_dim=cross_attention_dim)
