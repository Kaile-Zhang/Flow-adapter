...
from ip_adapter.attention_processor import InAttnProcessor2_0
...
def main():
    ...
    for name in unet.attn_processors.keys():
        ...
        if cross_attention_dim is None:
            ...
            attn_procs[name] = InAttnProcessor2_0(hidden_size=hidden_size, cross_attention_dim=cross_attention_dim)
