...
ip_ckpt = "output-flow2.1/checkpoint-16000/model.safetensors"
device = "cuda"
...
image_data = dict()
image_data['edit_prompt'] = "Rotate the sheep around the y-axis counterclockwise strongly"
image_data["ori_img_path"] = "/data/Hszhu/dataset/Gedi_full/source_img/281.png"
image_data["gen_img_path"] = "/data/Hszhu/dataset/Gedi_full/gen_img/281/0/12.png"
image_data["tag_caption"] = "a piece of art depicting a sheep with a purple background"
# read image prompt
