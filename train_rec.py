...
def main():
    ...
    inference = 0
    if inference:
        for i in adapter_modules.state_dict():
        ...
        for obj in ['cup', 'bear']:
            for step_num in [100, 200, 300, 400, 500, 700, 1000]:
                ckpt = f"output-{obj}/checkpoint-{step_num}/model.safetensors"
                ...
                for i in adapter_modules.state_dict():
                    ...
                    print(j)
                    break
                torch.save(adapter_modules, f'output-{obj}/adapter_modules-{step_num}.pth')
        exit()
